// =================================================================
// GENİŞLETİLMİŞ KPSS TARİH VERİ TABANI (GÜNCEL - YÜZYILLAR EKLENDİ)
// =================================================================
const database = {
    // --- 1. İSLAMİYET ÖNCESİ ---
    "islamiyet_oncesi": [
    ...
    // --- 5. OSMANLI ISLAHATLARI (TAM DETAYLI VE YÜZYILLI) ---
    "osmanli_islahat": [
        // --- 17. YÜZYIL (DURAKLAMA) ---
        ...
        { word: "İlk kez modern anlamda 'Denk Bütçe' çalışmasını yapan devlet adamı?", meaning: "Tarhuncu Ahmet Paşa (IV. Mehmet Dönemi) (17. YY)" },
        ...
        { word: "Nizam-ı Cedid ordusunun masraflarını karşılamak üzere kurulan hazine?", meaning: "İrad-ı Cedid Hazinesi (III. Selim Dönemi) (18. YY)" },
        ...
        // --- 19. YÜZYIL (II. MAHMUT ve SONRASI) ---
...
function startGame(categoryKey) {
    ...
    const titles = {
        ...
        "osmanli_islahat": "Osmanlı Islahatları",
