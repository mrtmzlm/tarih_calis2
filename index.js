...
"osmanli_kultur": [
    ...
    { word: "Osmanlı’da şer’i hukukun baş uygulayıcısı kimdir?", meaning: "Kadılar (Kazasker denetiminde)" },
    ...
    { word: "II. Murat'ın Haçlılara karşı kesin zafer kazandığı, Segedin Antlaşması'nı bozan Haçlılara ders veren savaş?", meaning: "Varna Savaşı (1444)" },
    ...
    { word: "Anadolu Türk siyasi birliğinin kesin olarak sağlandığı savaş?", meaning: "Turnadağ Savaşı (1515, Dulkadiroğulları Beyliği'nin yıkılması)" },
    ...
    { word: "Osmanlı'nın batıda taarruzdan savunmaya geçtiği (Sakarya Savaşı'na kadar sürecek) büyük bozgun?", meaning: "II. Viyana Kuşatması (1683)" },
    ...
    { word: "Osmanlı'dan bağımsızlığını kazanan ilk azınlık?", meaning: "Yunanlılar (Rumlar) / Edirne Antlaşması (1829)" },
    ...
    { word: "Osmanlı ekonomisinin dışa bağımlı hale geldiği (İngiltere ile yapılan) ticaret antlaşması?", meaning: "Balta Limanı Antlaşması (1838)" },
    { word: "Osmanlı'nın ilk kez Avrupa devleti sayıldığı antlaşma?", meaning: "Paris Antlaşması (Kırım Savaşı sonu, 1856)" },
    { word: "Rus donanmasının da yer aldığı, Osmanlı donanmasının yakıldığı üçüncü ve son olay?", meaning: "Sinop Baskını (1853)" },
    { word: "Ermeni sorununun uluslararası alanda ilk kez yer aldığı antlaşma?", meaning: "Berlin Antlaşması (1878)" },
    { word: "1877-1878 Osmanlı-Rus Savaşı Osmanlı tarihinde hangi adla bilinir?", meaning: "93 Harbi" },
    { word: "Kıbrıs'ın yönetiminin geçici olarak İngiltere'ye bırakılmasına yol açan gizli antlaşma?", meaning: "Kıbrıs Antlaşması / Kıbrıs Sözleşmesi (1878, II. Abdülhamid Dönemi)" },
    { word: "I. Meşrutiyet'i ilan ettiren ve Kanun-i Esasi'yi yürürlüğe koyan padişah?", meaning: "II. Abdülhamid (1876)" },
    { word: "Osmanlı Devleti'nde meclisin yeniden açılmasıyla başlayan dönem?", meaning: "II. Meşrutiyet (1908)" },
    { word: "Mustafa Kemal'in tarih sahnesine çıktığı ilk olay?", meaning: "31 Mart Olayı (Hareket Ordusu, 1909)" },
    { word: "Balkan Harbi sırasında İttihat ve Terakki'nin hükümeti devirdiği, iktidarı tamamen ele aldığı darbe?", meaning: "Bâbıâli Baskını (23 Ocak 1913)" },
    { word: "Kuzey Afrika'daki son toprak parçasının (Trablusgarp) kaybedildiği antlaşma?", meaning: "Uşi Antlaşması (1912)" },
    { word: "I. Balkan Savaşı'nda en karlı çıkan ve büyüyen devlet?", meaning: "Bulgaristan" },
    { word: "Osmanlı Devleti'nin imzaladığı, ancak yürürlüğe girmeyen en ağır barış antlaşması?", meaning: "Sevr Antlaşması (10 Ağustos 1920)" },
    { word: "Osmanlı'nın I. Dünya Savaşı'ndan çekildiği ateşkes antlaşması?", meaning: "Mondros Ateşkes Antlaşması (30 Ekim 1918)" },
  ...
  // --- 5. OSMANLI ISLAHATLARI (TAM DETAYLI VERSİYON) ---
    "osmanli_islahat": [
       { word: "Saray dışından evlenerek saray kadınlarının (Harem) yönetimdeki etkinliğini kıran ilk padişah?", meaning: "II. Osman (Genç Osman)" },
    { word: "Şeyhülislamın yetkilerini kısıtlayan ilk padişah?", meaning: "II. Osman (Genç Osman)" },
    { word: "Başkenti İstanbul'dan Anadolu'ya taşımayı düşünen padişah?", meaning: "II. Osman (Genç Osman)" },
    { word: "Yeniçeri Ocağı'nı kaldırmayı düşünen ilk padişah?", meaning: "II. Osman (Genç Osman)" },
    { word: "İçki, tütün yasağı getiren ve gece sokağa çıkma yasağı uygulayan padişah?", meaning: "IV. Murat" },
    { word: "Koçi Bey ve Katip Çelebi'ye devletin gidişatı hakkında risale hazırlatan padişah?", meaning: "IV. Murat" },
    { word: "İlk kez modern anlamda 'Denk Bütçe' çalışmasını yapan devlet adamı?", meaning: "Tarhuncu Ahmet Paşa (IV. Mehmet Dönemi)" },
    { word: "Sadrazamlık teklifini 'şartlar sunarak' kabul eden ilk devlet adamı?", meaning: "Köprülü Mehmet Paşa" },

    // --- 18. YÜZYIL (GERİLEME - Lale Devri ve Sonrası) ---
    { word: "Lale Devri'nin (1718-1730) padişahı kimdir?", meaning: "III. Ahmet" },
    { word: "Avrupa'dan getirilen ilk çiçek aşısı hangi padişah döneminde uygulandı?", meaning: "III. Ahmet" },
    { word: "İlk Türk matbaası (İbrahim Müteferrika) kimin döneminde kuruldu?", meaning: "III. Ahmet" },

    // EK: Lale Devri ve 18. yy ıslahatları
    { word: "İtfaiye teşkilatının temeli sayılan 'Tulumbacılar Ocağı'nı kurduran padişah?", meaning: "III. Ahmet" },
    { word: "Yalova'da ilk kağıt imalathanesinin (Kağıthane-i Yalakabad) açıldığı padişah dönemi?", meaning: "I. Mahmut" },

    { word: "Avrupa'yı örnek alarak askeri ıslahat yapan ilk padişah?", meaning: "I. Mahmut" },
    { word: "Batı tarzında açılan ilk teknik okul 'Hendesehane' kimin döneminde açıldı?", meaning: "I. Mahmut" },
    { word: "Humbaracı Ocağı'nı ıslah eden ve Comte de Bonneval'i getiren padişah?", meaning: "I. Mahmut" },
    { word: "Sürat Topçuları Ocağı'nı kuran padişah?", meaning: "III. Mustafa" },
    { word: "'Esham Sistemi'ni (İç Borçlanma) hazırlayan (ancak uygulayamayan) padişah?", meaning: "III. Mustafa" },
    { word: "'Esham Sistemi'ni uygulamaya koyan padişah?", meaning: "I. Abdülhamit" },

    // EK: Mühendishaneler
    { word: "Mühendishane-i Bahrî-i Hümâyun (ilk deniz mühendislik okulu) hangi padişah döneminde açıldı?", meaning: "III. Mustafa" },
    { word: "Mühendishane-i Berrî-i Hümâyun (kara mühendislik okulu) kimin döneminde açıldı?", meaning: "III. Selim" },

    { word: "Yeniçeri sayımını yapan ve Culus bahşişini kaldıran padişah?", meaning: "I. Abdülhamit" },
    { word: "Ulufe alım satımını yasaklayan padişah?", meaning: "I. Abdülhamit" },
    { word: "Nizam-ı Cedid ordusunu kuran padişah?", meaning: "III. Selim" },

    // EK: Nizam-ı Cedid ile ilgili hazine
    { word: "Nizam-ı Cedid ordusunun masraflarını karşılamak üzere kurulan hazine?", meaning: "İrad-ı Cedid Hazinesi (III. Selim Dönemi)" },

    { word: "İlk devlet matbaası (Matbaa-i Amire) kimin döneminde kuruldu?", meaning: "III. Selim" },
    { word: "Avrupa başkentlerinde (Londra, Paris vb.) ilk 'Daimi Elçilikler' kimin döneminde açıldı?", meaning: "III. Selim" },
    { word: "Fransızcanın ilk resmi yabancı dil (askeri okullarda) kabul edilmesi?", meaning: "III. Selim" },
    ...
    { word: "Asakir-i Mansure-i Muhammediye ordusunu kuran padişah?", meaning: "II. Mahmut" },
    { word: "Divan-ı Hümayun'u kaldırıp yerine Nazırlıkları (Bakanlıklar) kuran padişah?", meaning: "II. Mahmut" },
    { word: "Müsadere sistemini kaldıran padişah?", meaning: "II. Mahmut" },
    ...
    { word: "Devlet memurlarına fes, ceket ve pantolon giyme zorunluluğu getiren padişah?", meaning: "II. Mahmut" },
    { word: "İlköğretimi (İstanbul'da) zorunlu hale getiren padişah?", meaning: "II. Mahmut" },
    { word: "Mürur Tezkiresi (Pasaport/Geçiş belgesi) uygulamasını başlatan padişah?", meaning: "II. Mahmut" },
    { word: "Tıbbiye ve Harbiye okullarını açan padişah?", meaning: "II. Mahmut" },

    // EK: II. Mahmut dönemi diğer önemli ıslahatlar
    { word: "Tımar sistemini tamamen kaldıran padişah?", meaning: "II. Mahmut" },
    { word: "Osmanlı'da ilk modern posta teşkilatını (posta nezareti) kurduran padişah?", meaning: "II. Mahmut" },
    { word: "İlk karantina teşkilatını (Meclis-i Tahaffuz) kuran padişah?", meaning: "II. Mahmut" },

    // --- 19. YÜZYIL (ABDÜLMECİD - TANZİMAT DÖNEMİ) ---
    { word: "Tanzimat Fermanı'nı (Gülhane Hatt-ı Hümayunu) ilan eden padişah?", meaning: "Sultan Abdülmecid" },
    { word: "Islahat Fermanı'nı ilan ederek gayrimüslimlere geniş haklar veren padişah?", meaning: "Sultan Abdülmecid" },
    ...
    { word: "İlk telgraf hattı (İstanbul-Edirne-Kırım) kimin döneminde çekildi?", meaning: "Sultan Abdülmecid" },
    { word: "İlk demiryolu hattı (İzmir-Aydın) kimin döneminde yapıldı?", meaning: "Sultan Abdülmecid" },
    { word: "Erkek Öğretmen Okulu (Darülmuallimin) kimin döneminde açıldı?", meaning: "Sultan Abdülmecid" },
    { word: "Encümen-i Daniş (Bilim Kurulu) kimin döneminde kuruldu?", meaning: "Sultan Abdülmecid" },

    // EK: Abdülmecid dönemi
    { word: "Boğaziçi vapur taşımacılığı için kurulan ilk anonim şirket 'Şirket-i Hayriye' kimin döneminde kuruldu?", meaning: "Sultan Abdülmecid" },

    // --- 19. YÜZYIL (ABDÜLAZİZ) ---
    { word: "Yurt dışına seyahate çıkan ilk ve tek Osmanlı padişahı?", meaning: "Sultan Abdülaziz" },
    { word: "Osmanlı Donanmasını dünyanın en büyük 3. filosu haline getiren padişah?", meaning: "Sultan Abdülaziz" },
    ...
    { word: "Kız Öğretmen Okulu (Darülmuallimat) kimin döneminde açıldı?", meaning: "Sultan Abdülaziz" },

    // DÜZELTME: Hilal-i Ahmer padişahı KPSS mantığıyla
    { word: "Hilal-i Ahmer (Kızılay) cemiyeti kimin döneminde kuruldu?", meaning: "II. Abdülhamid" },

    // EK: Abdülaziz dönemi yüksek yargı kurumları
    { word: "Şûrâ-yı Devlet (Danıştay) ve Dîvân-ı Ahkâm-ı Adliyye (Yargıtay'ın temeli) hangi padişah döneminde kurulmuştur?", meaning: "Sultan Abdülaziz" },

    // --- 19. YÜZYIL (II. ABDÜLHAMİD) ---
    ...
    { word: "Ziraat Bankası (Memleket Sandıkları'nın dönüşümü) resmen kimin döneminde kuruldu?", meaning: "II. Abdülhamid" },
    { word: "Sanayi-i Nefise Mektebi (Güzel Sanatlar Fakültesi) kimin döneminde açıldı?", meaning: "II. Abdülhamid" },
    { word: "Ertuğrul Fırkateyni'ni Japonya'ya gönderen padişah?", meaning: "II. Abdülhamid" },
    { word: "Berlin-Bağdat demiryolu projesi (3B) kimin döneminde başladı?", meaning: "II. Abdülhamid" },
    { word: "Hamidiye Alayları (Doğu Anadolu için) kimin döneminde kuruldu?", meaning: "II. Abdülhamid" },
    { word: "Darülaceze (Düşkünler Yurdu) ve Şişli Etfal Hastanesi'ni kuran padişah?", meaning: "II. Abdülhamid" },
    { word: "Müze-i Hümayun (İstanbul Arkeoloji Müzesi - Osman Hamdi Bey) kimin döneminde kuruldu?", meaning: "II. Abdülhamid" },

    // EK: II. Abdülhamid dönemi
    { word: "Hicaz Demiryolu'nu (Şam - Medine hattı) yaptıran padişah?", meaning: "II. Abdülhamid" },
    { word: "II. Meşrutiyet'i ilan ederek Meclis-i Mebusan'ı yeniden açan padişah?", meaning: "II. Abdülhamid" }
    ],
...
// --- 6. İNKILAP TARİHİ (TAM KAPSAMLI) ---
   "inkilap_tarihi": [
    ...
    // --- TÜRKİYE'DE DEMOKRASİ – DARBE SÜRECİ ---
